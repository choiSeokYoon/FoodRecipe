      ...
      const myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              data: [
                detailPosts.INFO_ENG,
                detailPosts.INFO_CAR,
                detailPosts.INFO_PRO,
                detailPosts.INFO_FAT,
                detailPosts.INFO_NA,
              ],
              backgroundColor: [
                "#FF6384",
  ...
  return (
    <div className="detail_item_right">
      ...
      <div className="detail_etc">
        {teb === 2 && <canvas className="myChart"></canvas>}
      </div>
    </div>
  );
}
